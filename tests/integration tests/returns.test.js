...
describe('/api/returns', () => {
  ...
  it('should return 400 if rental already sent', async () => {
  ...
  it('should return 200 if valid request is sent', async () => {
    const res = await exec()
  ...
  it('should increase the stock in movie if input is valid', async () => {
    await exec()
